    ...
    <div class="page-wrapper">
        ...
        <?php include "component/headerDesktop.php"?>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light m-2">
                <a class="navbar-brand" href="#">Cari Data Guru</a>
                ...
                <div class="row p-2">
                    ...
                    <div class="card">
                        <div class="card-header">Laporan Absensi Guru</div>
                        <div class="card-body">
                        ...
                        <div class="col-md-12 pl-0 pr-0">
                                ...
                                <?php
                                    ...
                                    if(isset($_POST['cari'])){
                                        ...
                                        $data = mysqli_query($connect, "SELECT * FROM buku_guru WHERE $select LIKE '$string%' ");
                                        $showData = mysqli_num_rows($data); 
                                    }elseif(isset($_POST['semua'])){

                                        $data = mysqli_query($connect, "SELECT * FROM buku_guru");
                                        $showData = mysqli_num_rows($data);
                                    }else{
                                        $data = mysqli_query($connect, "SELECT * FROM buku_guru");
                                        $showData = mysqli_num_rows($data);
