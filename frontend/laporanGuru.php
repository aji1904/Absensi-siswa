    ...
    <div class="page-wrapper">
        ...
        <?php include "component/headerDesktop.php"?>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light m-2">
                <a class="navbar-brand" href="#">Cari Guru</a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form class="form-inline my-2 my-lg-0" method="POST">
                        <select id="ket" name="select" class="form-control m-2" required>
                            ...
                            <option value="status_guru">Pelajaran</option>
                ...
                <div class="row p-2">
                    ...
                    <div class="card">
                        <div class="card-header">Laporan Guru<div>
                        ...
                        <div class="col-md-12 pl-0 pr-0">
                                ...
                                <?php
                                    ...
                                    if(isset($_POST['cari'])){
                                        ...
                                        $data = mysqli_query($connect, "SELECT * FROM absen_guru WHERE $select LIKE '$string%' ");
                                        $showData = mysqli_num_rows($data); 
                                    }elseif(isset($_POST['semua'])){

                                        $data = mysqli_query($connect, "SELECT * FROM absen_guru");
                                        $showData = mysqli_num_rows($data);
                                    }else{
                                        $data = mysqli_query($connect, "SELECT * FROM absen_guru");
                                        $showData = mysqli_num_rows($data);
